...
class HostapdConfig(object):
    ...
    def populate_eap(self, settings, options):
        ...
        eap_configs = {
            ...
            'eaphammer_logfile' : os.path.join(settings.dict['paths']['directories']['log'], (options['essid']) + ".log"),
    ...
    def populate_general(self, settings, options):
        ...
        general_configs['ieee80211n'] = '1'
        general_configs['ieee80211ac'] = '1'
        general_configs['ieee80211ax'] = '1'
        general_configs['wmm_enabled']= '1'
        general_configs['vht_capab'] = '[SOUNDING-DIMENSION-2][BF-ANTENNA-2]'
        # general_configs['asdf'] = '1' # does not works, good
        general_configs['hw_mode']  = 'g' # works
        # general_configs['hw_mode']  = 'ac'
